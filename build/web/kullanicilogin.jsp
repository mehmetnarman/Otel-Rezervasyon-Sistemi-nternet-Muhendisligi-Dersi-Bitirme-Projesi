<%-- 
    ...
    Created on : 15.Oca.2021, 22:04:03
...
<html>
    ...
    <section class="adminlogin">
        <div class="card z-depth-3">
            ...
            <form class="form" action="kullaniciKontrol.jsp" method="post"> 
                <div class="input-field"><br></br>
                    <input type="email" placeholder="Email" class="validate" name="mail" required>
                </div>
                <div class="input-field"><br></br>
                ...
                <div class="center pt-1">
                    <a href="KullanıcıEkle/KullaniciSifreOlustur.jsp">Kaydol</a>
                </div>
            </form>
        </div>
    </section>
